      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 md:py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Atasan", "Bawahan", "Outerwear", "Skirts", "Thrifting"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-neutral-500 hover:text-pink-500 transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Tentang Kami", "Cara Pemesanan", "Kebijakan Pengembalian", "FAQ"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-neutral-500 hover:text-pink-500 transition-colors">
                    {item}
                  </a>
        ...
        <div className="border-t border-pink-100 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-xs text-neutral-400 hover:text-pink-400 transition-colors">
              Syarat & Ketentuan
            </a>
            <a href="#" className="text-xs text-neutral-400 hover:text-pink-400 transition-colors">
              Kebijakan Privasi
